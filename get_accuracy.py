...
print("identity", "%4.1f %4.1f %4.1f %4.1f %4.1f" % (np.percentile(values, 10), np.percentile(values, 25), np.percentile(values, 50), np.percentile(values, 75), np.percentile(values, 90)))
values = np.array(list(istats.values()))
print("inserts ", "%4.1f %4.1f %4.1f %4.1f %4.1f" % (np.percentile(values, 10), np.percentile(values, 25), np.percentile(values, 50), np.percentile(values, 75), np.percentile(values, 90)))
values = np.array(list(dstats.values()))
print("deletes ", "%4.1f %4.1f %4.1f %4.1f %4.1f" % (np.percentile(values, 10), np.percentile(values, 25), np.percentile(values, 50), np.percentile(values, 75), np.percentile(values, 90)))
